  ...
  test "nav includes social links when configured" do
    AppConfig.stub(:instagram_url, "https://www.instagram.com/aotearoaagain") do
      AppConfig.stub(:facebook_url, "https://www.facebook.com/aotearoaagain") do
        AppConfig.stub(:youtube_url, "https://www.youtube.com/@aotearoaagain") do
          get about_url
          assert_response :success
          ...
          assert_select "nav.aa-nav a[href='https://www.youtube.com/@aotearoaagain'][aria-label='YouTube']"
          ...
          assert_select "footer.aa-footer a[href='https://www.youtube.com/@aotearoaagain'][aria-label='YouTube (@aotearoaagain)']", text: /@aotearoaagain/
        end
      end
    end
  end
    ...
    AppConfig.stub(:instagram_url, nil) do
      AppConfig.stub(:facebook_url, nil) do
        AppConfig.stub(:youtube_url, nil) do
          ...
          assert_select "footer.aa-footer a[aria-label='YouTube']", count: 0
